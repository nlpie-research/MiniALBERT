...
ds = load_from_disk("tokenizedDatasets/pubmed-256/") #Path to the tokenized dataset
...
student = MiniAlbertForMaskedLM(config=pretrainedConfig, pretrained_embeddings=ts.AutoModel.from_pretrained("nlpie/tiny-biobert").embeddings)
...
savePath = "miniALBERT/models/bio-miniALBERT/"
